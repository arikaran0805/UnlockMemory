          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              ...
              {user ? (
                ...
                <Button 
                  asChild 
                  className="hidden md:flex h-10 px-6 rounded-full bg-primary text-primary-foreground hover:bg-primary/90 font-semibold transition-all duration-300 shadow-md text-sm"
                >
