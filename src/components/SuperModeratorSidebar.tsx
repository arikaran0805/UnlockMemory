...
const SuperModeratorSidebar = ({
  ...
  const isActive = (path: string) => {
    if (path === "/super-moderator/dashboard")
      return location.pathname === "/super-moderator/dashboard" || location.pathname === "/super-moderator";
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden px-2 py-1" style={{ scrollbarWidth: "none" } as React.CSSProperties}>
        {superModeratorSidebarConfig.sections.map((section, si) => (
