...
import { Bookmark, CheckCircle2, ChevronLeft } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-8">
        ...
        {/* ── Skill Hero Header — skeleton while skillLoading ── */}
            ...
            {skillLoading ? (
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 space-y-2.5">
                  ...
                  <div className="h-3.5 w-72 rounded bg-muted/40 animate-pulse" />
                </div>
                <div className="flex flex-col items-end gap-2 shrink-0">
                  <div className="h-7 w-28 rounded-full bg-muted/60 animate-pulse" />
                  <div className="h-1.5 w-28 rounded-full bg-muted/40 animate-pulse" />
                </div>
              </div>
            ) : (
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  <h1 className="text-[26px] font-bold leading-tight tracking-[-0.025em] text-foreground mb-1.5">
                    {skill?.name || "Skill"}
                  </h1>
                  ...
                  <div className="flex flex-col items-end gap-2 shrink-0">
                    ...
                    <div className="w-28 h-1.5 rounded-full bg-muted/60">
                      <div
                        ...
                        style={{ width: `${solvedPct}%`, background: "linear-gradient(90deg, #4CAF82, #22C55E)" }}
                      />
                    </div>
        ...
        {/* ── Problem list — skeleton while problemsLoading ── */}
        <div className="space-y-4">
          {problemsLoading ? (
            // Inline skeleton for problem rows
            <div className="space-y-4">
              {[1, 2].map((i) => (
                <div key={i} className="bg-card rounded-xl border border-border/50 shadow-sm overflow-hidden animate-pulse">
                  ...
                  {[1, 2, 3].map((j) => (
                    <div key={j} className="px-4 py-3.5 flex items-center justify-between border-b border-border/20 last:border-0">
